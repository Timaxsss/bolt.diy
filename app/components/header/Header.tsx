    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        <a href="/" className="text-2xl font-semibold text-accent flex items-center">
          ...
          <img src="/Raibbit-Logo-Site-01.png" alt="logo" className="w-[90px] inline-block dark:hidden" />
          <img src="/Raibbit-Logo-Site-01.png" alt="logo" className="w-[90px] inline-block hidden dark:block" />
        </a>
      </div>
